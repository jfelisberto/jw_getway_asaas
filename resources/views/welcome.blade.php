...
<head>
    <script src="{{ asset('plugins/bootstrap/js/color-modes.js') }}"></script>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="description" content="">
    <meta name="author" content="Juliano Eloi Felibserto">
...
<body class="bg-body-tertiary">
    ...
    <div class="container">
        <main>
            ...
            <div class="py-5 text-center">
                <a href="{{ route('home') }}"><img class="d-block mx-auto mb-4" src="{{ asset('logo_jefweb.png') }}" alt="" width="72"
                    height="57"></a>
                @if($cart)
                <h2>Formulário de Checkout</h2>
                <p class="lead">Preencha o formulário abaixo para confirmar sua compra.</p>
                @endif
            </div>
                ...
                <div class="col-md-5 col-lg-4 order-md-last">
                    ...
                    <ul class="list-group mb-3">
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            ...
                            <span class="text-body-secondary">R$125,36</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            <div>
                            ...
                            <span class="text-body-secondary">R$8,35</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            <div>
                                <h6 class="my-0">Terceio produto</h6>
                                <small class="text-body-secondary">Descrição breve</small>
                            </div>
                            <span class="text-body-secondary">R$5,17</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between bg-body-tertiary">
                            <div class="text-success">
                                <h6 class="my-0">Código promocional</h6>
                                <small>EXAMPLECODE15</small>
                            </div>
                            <span class="text-success">R$-15,00</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            <span>Total (R$)</span>
                            <strong>R$123,88</strong>
                        </li>
                    </ul>
        ...
        <footer class="my-5 pt-5 text-body-secondary text-center text-small">
            <p class="mb-1">&copy; 2024 JEFWeb</p>
    ...
    <script src="{{ asset('plugins/bootstrap_notify/bootstrap-notify.min.js') }}"></script>
    <script src="{{ asset('plugins/sweetalert/js/sweetalert2.min.js') }}"></script>
