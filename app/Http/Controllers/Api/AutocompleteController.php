...
// dump($response);
            if ($response['status'] == 'success') {
                ...
                // dump($res,$res2);
                if ((isset($res['erro']) && $res['erro']) && (isset($res2['resultado']) && $res2['resultado'] == 0)) {
                    $result = $response;
                    ...
                    $result['address'] = trim($res['logradouro']);
        ...
        try {
            ...
            if ($response['status'] == 'success') {
                ...
                if (count($newData[0]) >= 1) {
                    ...
                    $result = $newDatalist2;
                    if (isset($newDatalist2['e_mail'])) {
                        $result['e_mail'] = strtolower($newDatalist2['e_mail']);
                    }

                    if (isset($newDatalist2['socio'])) {
